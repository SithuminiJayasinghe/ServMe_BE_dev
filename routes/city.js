...
// ////////////////////////////////////////////////////////
//Get City Detail is Special Discount

/* Get City Detail is Special Discount Service. */
router.get('/get', (req, res) => {
    ...
    mysqlConnection = mysqlPool((err, connection) => {
        if (err) {
            ...
            var sql = "select * from serv_me.city" ;
            console.log(sql);
            connection.query(sql, function (err, result) {
                ...
                if (err) {
                    ...
                    //connection.release();
                    logger.info('got City detail all view results set now !');
